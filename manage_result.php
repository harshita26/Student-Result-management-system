            ...
            <div class="col-12">
                <form action="" method="post">
                    <fieldset>
                        ...
                        <input type="submit" value="Delete" class="form-control bg-secondary border-0 text-white"name="delete">
                        <div class="msg">
                            <p id="demo"></p>
                        </div>
                    </fieldset>
            ...
            <div class="col-12">
                <form action="" method="post">
                    <fieldset>
                        ...
                        <input type="submit" value="Update" class="form-control bg-secondary border-0 text-white"name="update">
                        <div class="msg">
                                <p id="demo1"></p>
                        </div>
                    </fieldset>
...
if(isset($_POST['delete'])){
    ...
    $croll=$_POST['rollno'];
    $qry="DELETE FROM `add_result` WHERE `sclass`='$sclass' AND `sroll`='$croll';";
    $run=mysqli_query($con,$qry);    
    if(!$run){
        ?>
            <script>document.getElementById("demo").innerHTML="DATA IS NOT DELETE";</script>
        <?php
    }
    else{
        ?>
            <script>document.getElementById("demo").innerHTML="DATA IS DELETE";</script>
        <?php
    }
}
...
if(isset($_POST['update'])){
    ...
    $s4=$_POST['p4'];
    $s5=$_POST['p5'];
    $qry="UPDATE `add_result` SET `sclass`='$sclass',`sroll`='$croll',`p1`='$s1',`p2`='$s2',`p3`='$s3',`p4`='$s4',`p5`='$s5' WHERE `sclass`='$sclass' AND `sroll`='$croll';";
    $run=mysqli_query($con,$qry);    
    if(!$run){
        ?>
            <script>document.getElementById("demo1").innerHTML="DATA IS NOT UPDATED";</script>
        <?php
    }
    else{
        ?>
            <script>document.getElementById("demo1").innerHTML="DATA IS UPDATED";</script>
        <?php
    }
}
?>
